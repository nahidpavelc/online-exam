            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body card-body-bor">
                        ...
                        {/* row-3 */}
                        <div className="d-flex justify-content-between card-course" style={{ fontSize: "12px" }}>
                            <div className="">
                    ...
                    <div class="card-footer d-flex justify-content-between ">
                        <div className="">
                            <img className="card-footer-img"
                                src="http://bhaters.abrms.com/uploads/user_image/placeholder.png" alt="" />
                        </div>
                        <div>
                            <h5>$59</h5>
                        </div>
